...
WebUI.setText(findTestObject('dangnhap/txt_email'), 'mnhh1005@gmail.com')

WebUI.setText(findTestObject('dangnhap/txt_matkhau'), 'pmanh100504')
...
WebUI.verifyTextPresent('Phạm Văn Mạnh', false)
